...
/*
  ...
  */
  ...
  // ============================
  // Checks when point constructed with 2 int parameters
  @Test
  public void pointConstructor3() {
    assertTrue(equalPoints(new Point(1, 2), new Point(1,2)));
  }
  // Checks when x is at the edge of the graph
  @Test
  public void pointIsLeftOf2() {
    assertFalse(new Point(0, 0).isLeftOf(new Point(0, 20)));
  }
  // Checks when one is above the other
  // Checks when at the bottom of the graph
  @Test
  public void pointIsBelow2() {
    assertTrue(new Point(3, 12).isBelow(new Point(3, 11)));
    assertFalse(new Point(0, 0).isBelow(new Point(11, 0)));
  }
  // Adds 2 origin points
  @Test
  public void pointAdd2() {
    assertTrue(equalPoints(new Point(0, 0).add(new Point(0, 0)), new Point(0, 0)));
  }
  // ================================
  // Additional tests for Rectangle.
  // ================================
  // Checks if width is 0 when the xs are the same
  @Test
  public void rectangleGetWidth1() {
    assertEquals(new Rectangle(new Point(11, 1), new Point(11, 11)).getWidth(), 0);
  }
  // Checks if height is 0 when the ys are the same
  @Test
  public void rectangleGetHeight1() {
    assertEquals(new Rectangle(new Point(1, 11), new Point(11, 11)).getHeight(), 0);
  }
  // Checks area is 0 if height or width is 0
  @Test
  public void rectangleArea1() {
    assertEquals(0, new Rectangle(10, 0).area());
    assertEquals(0, new Rectangle(0, 5).area());
  }
  // Checks intersection
  @Test
  public void rectangleIntersect4() {
    assertFalse(
            new Rectangle(new Point(0, 0), 3, 3).intersects(new Rectangle(new Point(12, 12), 10, 10)));
  }

  // =====================================
  // Additional tests for ListAlgorithms.
  // =====================================
  private static final List<Rectangle> VARIOUS_RECTANGLES1 =
          Arrays.asList(
                  new Rectangle(new Point(15, 25), 10, 10), new Rectangle(new Point(20, 100), 5, 5));

  private static final List<Rectangle> VARIOUS_RECTANGLES_TRANSLATED1 =
          Arrays.asList(
                  new Rectangle(new Point(65, 75), 10, 10), new Rectangle(new Point(70, 150), 5, 5));

  private static final List<Rectangle> VARIOUS_RECTANGLES_SCALED1 =
          Arrays.asList(
                  new Rectangle(new Point(15, 25), 50, 50), new Rectangle(new Point(20, 100), 25, 25));

  //Checks if the rectangles in the list are translated by (50,50)
  @Test
  public void listTranslate1() {
    assertTrue(
            equalRectangleLists(
                    VARIOUS_RECTANGLES_TRANSLATED1,
                    ListAlgorithms.translate(VARIOUS_RECTANGLES1, new Point(50, 50))));
  }

  // Checks if the rectangles in the list are scaled by a factor of 5
  @Test
  public void listScale1() {
    assertTrue(
            equalRectangleLists(
                    VARIOUS_RECTANGLES_SCALED1, ListAlgorithms.scale(VARIOUS_RECTANGLES1, 5)));
  }

  // Checks the bottom left points of the rectangles in the list
  @Test
  public void listGetBottomLeft1() {
    List<Point> bottomLeft = ListAlgorithms.getBottomLeftPoints(VARIOUS_RECTANGLES1);
    List<Point> expected = Arrays.asList(new Point(15, 35), new Point(20, 105));
    assertTrue(equalPointLists(bottomLeft, expected));
  }

  // Checks max height of the passed list of rectangles
  @Test
  public void listFindMaxHeight1() {
    assertEquals(10, ListAlgorithms.findMaxHeight(VARIOUS_RECTANGLES1));
    assertEquals(10, ListAlgorithms.findMaxHeight(VARIOUS_RECTANGLES_TRANSLATED1));
    assertEquals(50, ListAlgorithms.findMaxHeight(VARIOUS_RECTANGLES_SCALED1));
  }
  ...
  // Checks if the rectangles in the stream are translated by (50,50)
  @Test
  public void streamTranslate1() {
    assertTrue(
            equalRectangleLists(
                    VARIOUS_RECTANGLES_TRANSLATED1,
                    StreamAlgorithms.translate(VARIOUS_RECTANGLES1.stream(), new Point(50, 50))
                            .collect(toList())));
  }

  // Checks if the rectangles in the stream are scaled by a factor of 5
  @Test
  public void streamScale1() {
    assertTrue(
            equalRectangleLists(
                    VARIOUS_RECTANGLES_SCALED1,
                    StreamAlgorithms.scale(VARIOUS_RECTANGLES1.stream(), 5).collect(toList())));
  }

  // Checks the bottom left points of the rectangles in the stream
  @Test
  public void streamGetBottomLeft1() {
    List<Point> bottomLeft =
            StreamAlgorithms.getBottomLeftPoints(VARIOUS_RECTANGLES1.stream()).collect(toList());
    List<Point> expected = Arrays.asList(new Point(15, 35), new Point(20, 105));
    assertTrue(equalPointLists(bottomLeft, expected));
  }

  // Checks max height of the passed stream of rectangles
  @Test
  public void streamFindMaxHeight1() {
    assertEquals(10, StreamAlgorithms.findMaxHeight(VARIOUS_RECTANGLES1.stream()));
    assertEquals(10, StreamAlgorithms.findMaxHeight(VARIOUS_RECTANGLES_TRANSLATED1.stream()));
    assertEquals(50, StreamAlgorithms.findMaxHeight(VARIOUS_RECTANGLES_SCALED1.stream()));
  }
  ...
  // Checks for intersecting rectangle
  @Test
  public void rectangleIntersection4() {
    assertTrue(
            equalRectangles(
                    new Rectangle(new Point(20, 20), 0, 0),
                    new Rectangle(new Point(0, 0), 20, 20)
                            .intersection(new Rectangle(new Point(20, 20), 20, 20))
                            .get()));
  }

  // Check if there is an intersecting rectangle present
  @Test
  public void streamIntersectAll3() {
    assertFalse(StreamAlgorithms.intersectAll(VARIOUS_RECTANGLES_TRANSLATED1.stream()).isPresent());
  }
